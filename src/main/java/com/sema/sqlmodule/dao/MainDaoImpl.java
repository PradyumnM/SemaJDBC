...
public class MainDaoImpl implements MainDao {
	...
	public void insertControlSampleVariant (final ArrayList<ControlSampleVariable> controlSampVarlist){
		String SQL = "INSERT INTO control_sample_variants_reference (sample_id,target_name,chromosome,position,ref_allele,alt_allele,gene,cdna_change,protein_change,expected_al,expected_al_start,expected_al_end) VALUES ()";
		...
		jdbcTemplateObject.batchUpdate(SQL, new BatchPreparedStatementSetter() {
			   ...
			   public void setValues(PreparedStatement ps, int i)
			    ...
			    ps.setString(1, rec.getName());
			    ps.setString(2, rec.getGene());
			    ps.setString(3, rec.getName());
			    ps.setString(4, rec.getName());
			    ps.setString(5, rec.getName());
			    ps.setString(6, rec.getName());
			    ps.setString(7, rec.getName());
			    ps.setString(8, rec.getName());
			    ps.setString(9, rec.getName());
			    ps.setString(10, rec.getName());
                ps.setString(11, rec.getName());
			    ps.setString(12, rec.getName());
			    ps.setString(13, rec.getName());
